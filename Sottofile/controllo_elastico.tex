\capitolo{Controllo del Moto per Trasmissione Elastica Senza Gioco}
...
\begin{enumerate}[label=\roman*.]
    ...
    Come fare a variare il rapporto di inerzia \(\rho = \frac{\tau_R^2 J_c}{J_M}\):
        \begin{enumerate}[label=\alph*)]
            ...
            \item Utilizzo di motori ad alta inerzia, sono costruttivamente diffenti rispetto i motori tradizionali, hanno un raggio maggiore e lunghezza minore, così \(J_M \uparrow \alpha R^2 \). Questa è una alternativa al volano, risulta comunque inefficiente.
...
%% immagine dei 3 Kpv da lezione 31, verificare dove vada Kp2, se xi massimo o Re massimo
