...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textiwidth]{Immagini/armonica_colocato_v.png}
    \includegraphics[width=0.45\textiwidth]{Immagini/sinusoidale_colocato_v.png}
