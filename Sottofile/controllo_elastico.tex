...
%% inserire immagine bode mobilità per Gvc
...
%% inserire immagine luogo delle radici per controlli co-locato e non co-locato

\sottosezione{Trasmissibilità}
A completamento dell'analisi, si può studiare anche la trasmissibilità \(T(s) = \tau \frac{1+\frac{2\xi_z}{\omega_z}s}{1+\frac{2\xi_z}{\omega_z}s + \frac{s^2}{\omega_p^2}}\). Da notare come ad alta frequenza (come visto in Meccanica delle Vibrazioni) vi sia la zona di non trasmissione del moto, con modulo fortemente attenuato e ritardo. Il moto relativo di motore e carico è "grande".

%% inserire immagine bode trasmissibilità
...
%% inserire immagini per vari \rho per rlocus e bode
