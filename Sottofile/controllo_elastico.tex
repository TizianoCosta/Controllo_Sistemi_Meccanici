...
Per la scelta del guadagno si può utilizzare la formulazione empirica \(K_{pp} = \frac{\omega_{bv}}{4\xi_{des}^2}\), con \(\xi\in [1;1.5]\), mentre nel caso di risonanza in bassa o media frequenza è preferibile utilizzare \(\xi \simeq 1.4\), da cui \(K_{pp}\simeq \frac{\omega_{bv}}{8}\).
...
%% appendice MV aggiungere immagini