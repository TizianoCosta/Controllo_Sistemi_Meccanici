...
Da questa espressione è possibile ricavare il guadagno massimo per l'anello di velocità: \(K_{pv} \leqslant \tan{\left{\omega_\phi^\text{dis, minima} - \atan{4(1+\rho)} \right}}\frac{J_m}{K_{T}T_{eq}} \).
