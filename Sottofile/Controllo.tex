...
% inserire immagine schema a blocchi anello di velocità
...
% inserire immagine di schema a blocchi semplificato
...
% inserire immagine risposta al gradino e significato di \(\tau\)
...
% inserire grafico in cui si veda come con poli aventi \epsilon=0.5 cambi la sovraelongazione variando \alpha 
...
%% aggiungere parte di appendice sui sistemi del secondo ordine pag 54 finale e 55 fino effetto dello zero reale
% aggiungere immagini