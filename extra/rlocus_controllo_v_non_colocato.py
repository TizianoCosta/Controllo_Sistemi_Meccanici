...
denominator = s * Jtot * (s**2 / omega_p**2 + s * 2 * xi_p / omega_p + 1)
...
K_values = np.linspace(0, 1, 500)  # Adatta la gamma in base alla scala del tuo sistema
...
plt.ylim(-30, 30)
plt.xlim(-60,10)
plt.savefig('controllo_v_non_colocato.png', dpi=300)
plt.show()